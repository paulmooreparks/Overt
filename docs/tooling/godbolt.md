...
Overt transpiles to C# (primary, via Roslyn) and Go (secondary), rather than lowering to IR/asm itself. That gives three natural "output" modes — CE supports all of them through the same mechanism:
