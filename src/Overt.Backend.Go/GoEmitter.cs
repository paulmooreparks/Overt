...
public static class GoEmitter
{
    ...
    private sealed class EmitterInstance
    {
        ...
        public string Emit()
        {
            _sb.AppendLine("// Code generated by Overt.Backend.Go. DO NOT EDIT.");
            _sb.AppendLine($"// Transpiled from Overt module `{_module.Name}`.");
            _sb.AppendLine();
            _sb.AppendLine("package main");
            _sb.AppendLine();
            _sb.AppendLine("import (");
            _sb.AppendLine("\t\"os\"");
            _sb.AppendLine("\t\"overt-runtime/overt\"");
            _sb.AppendLine(")");
            _sb.AppendLine();
